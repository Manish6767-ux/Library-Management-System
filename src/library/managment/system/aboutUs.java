...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            super("About Us - mj");
            setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\IMG_20180721_170424"));
            ...
            ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("library/managment/system/icons/logo.png"));
            ...
            JLabel l6 = new JLabel("Developed By : Manish Jangir");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : Manishjangir770@gmail.com");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Follow us on Facebook : Manish jangid");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Follow us on Instagram : manish_jangid_mj");
